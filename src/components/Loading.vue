<template>
  <div class="bg-gray-200 opacity-35 fixed top-0 right-0 inset-0 z-50 grid place-items-center" v-show="loading">
    <div class="animation-loading animate-spin">
      <svg class="h-32 w-32"  width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <defs>
